...
func enforcePolicy(policyID string) {
    if policyID != "02f4a69f08664102360976a23e2c3b648cb219dad76de89aa88ac98e7b3a6d8a" {
...
func processLogFile(logFile string, fileHash string, user string, policy int, config PolicyConfig) {
    ...
    for _, algo := range []string{"HeuristicMiner", "AlphaMiner"} {
...
func main() {
    enforcePolicy("02f4a69f08664102360976a23e2c3b648cb219dad76de89aa88ac98e7b3a6d8a")
